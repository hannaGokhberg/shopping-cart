export const products = [
  ...
  },
  {
    ...
    water: 1,
    light: 5,
    picture: '/assets/images/crassula.png',
    // tslint:disable-next-line: max-line-length
    description: 'Crassula is one of the most common and beloved growers of indoor plants. It is phenomenally unpretentious, survives with any care errors, withstands both bright light and shading, can do without watering for a long time. And at the same time, this succulent has a spectacular appearance, is easy to shape and shear, allowing you to create spectacular compositions and bonsai.'
  },
  {
    name: 'Lemon tree',
    price: 25,
...
// tslint:disable-next-line: max-line-length
  ...
  },
  {
    ...
    water: 2,
    light: 5,
    picture: '/assets/images/solanum.png',
// tslint:disable-next-line: max-line-length
    description: 'Solanum is a very light-loving plant. If the light is not enough, it will lead to the fact that the leaves on the stems will be small, and the flower itself will not bear fruit. If possible, place the flower pot on the window on the west or east side. Nightshade should be kept only on hot summer days in order to protect its leaves from "burns." The rest of the time, sunlight will only benefit the plant.'
  },
];
